...
// checks if the InputGraphVisualizationPie type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InputGraphVisualizationPie{}

// InputGraphVisualizationPie struct for InputGraphVisualizationPie
type InputGraphVisualizationPie struct {
...
type _InputGraphVisualizationPie InputGraphVisualizationPie
...
func NewInputGraphVisualizationPie(type_ string, source string, queries []AggregationQuery1) *InputGraphVisualizationPie {
	this := InputGraphVisualizationPie{}
	this.Type = type_
	this.Source = source
...
func (o InputGraphVisualizationPie) MarshalJSON() ([]byte, error) {
...
func (o InputGraphVisualizationPie) ToMap() (map[string]interface{}, error) {
...
func (o *InputGraphVisualizationPie) UnmarshalJSON(data []byte) (err error) {
	...
	varInputGraphVisualizationPie := _InputGraphVisualizationPie{}

	err = json.Unmarshal(data, &varInputGraphVisualizationPie)

	if err != nil {
		return err
	}

	*o = InputGraphVisualizationPie(varInputGraphVisualizationPie)
...
type NullableInputGraphVisualizationPie struct {
	value *InputGraphVisualizationPie
	isSet bool
}

func (v NullableInputGraphVisualizationPie) Get() *InputGraphVisualizationPie {
	return v.value
}

func (v *NullableInputGraphVisualizationPie) Set(val *InputGraphVisualizationPie) {
	v.value = val
	v.isSet = true
}

func (v NullableInputGraphVisualizationPie) IsSet() bool {
	return v.isSet
}

func (v *NullableInputGraphVisualizationPie) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInputGraphVisualizationPie(val *InputGraphVisualizationPie) *NullableInputGraphVisualizationPie {
	return &NullableInputGraphVisualizationPie{value: val, isSet: true}
}

func (v NullableInputGraphVisualizationPie) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInputGraphVisualizationPie) UnmarshalJSON(src []byte) error {
	v.isSet = true
