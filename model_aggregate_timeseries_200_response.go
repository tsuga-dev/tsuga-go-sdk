...
// checks if the AggregateTimeseries200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregateTimeseries200Response{}
...
func NewAggregateTimeseries200Response(requestId string, data TimeseriesAggregationResponse) *AggregateTimeseries200Response {
	this := AggregateTimeseries200Response{}
...
func (o AggregateTimeseries200Response) ToMap() (map[string]interface{}, error) {
...
func (o *AggregateTimeseries200Response) UnmarshalJSON(data []byte) (err error) {
...
type NullableAggregateTimeseries200Response struct {
	value *AggregateTimeseries200Response
	isSet bool
}

func (v NullableAggregateTimeseries200Response) Get() *AggregateTimeseries200Response {
	return v.value
}

func (v *NullableAggregateTimeseries200Response) Set(val *AggregateTimeseries200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAggregateTimeseries200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAggregateTimeseries200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAggregateTimeseries200Response(val *AggregateTimeseries200Response) *NullableAggregateTimeseries200Response {
	return &NullableAggregateTimeseries200Response{value: val, isSet: true}
}

func (v NullableAggregateTimeseries200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAggregateTimeseries200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
