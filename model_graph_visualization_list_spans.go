...
// checks if the GraphVisualizationListSpans type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GraphVisualizationListSpans{}

// GraphVisualizationListSpans struct for GraphVisualizationListSpans
type GraphVisualizationListSpans struct {
	...
	// Whether list widget cell text wraps instead of truncating. Applies to span list widgets.
...
type _GraphVisualizationListSpans GraphVisualizationListSpans
...
func NewGraphVisualizationListSpans(type_ string, query string) *GraphVisualizationListSpans {
	this := GraphVisualizationListSpans{}
	this.Type = type_
	this.Query = query
	return &this
}
...
func (o GraphVisualizationListSpans) MarshalJSON() ([]byte, error) {
...
func (o GraphVisualizationListSpans) ToMap() (map[string]interface{}, error) {
...
func (o *GraphVisualizationListSpans) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphVisualizationListSpans := _GraphVisualizationListSpans{}

	err = json.Unmarshal(data, &varGraphVisualizationListSpans)

	if err != nil {
		return err
	}

	*o = GraphVisualizationListSpans(varGraphVisualizationListSpans)
...
type NullableGraphVisualizationListSpans struct {
	value *GraphVisualizationListSpans
	isSet bool
}

func (v NullableGraphVisualizationListSpans) Get() *GraphVisualizationListSpans {
	return v.value
}

func (v *NullableGraphVisualizationListSpans) Set(val *GraphVisualizationListSpans) {
	v.value = val
	v.isSet = true
}

func (v NullableGraphVisualizationListSpans) IsSet() bool {
	return v.isSet
}

func (v *NullableGraphVisualizationListSpans) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGraphVisualizationListSpans(val *GraphVisualizationListSpans) *NullableGraphVisualizationListSpans {
	return &NullableGraphVisualizationListSpans{value: val, isSet: true}
}

func (v NullableGraphVisualizationListSpans) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGraphVisualizationListSpans) UnmarshalJSON(src []byte) error {
	v.isSet = true
