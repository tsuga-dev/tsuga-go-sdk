...
// checks if the InputMonitorConfigurationMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InputMonitorConfigurationMetric{}

// InputMonitorConfigurationMetric struct for InputMonitorConfigurationMetric
...
type _InputMonitorConfigurationMetric InputMonitorConfigurationMetric
...
func (o InputMonitorConfigurationMetric) MarshalJSON() ([]byte, error) {
...
func (o InputMonitorConfigurationMetric) ToMap() (map[string]interface{}, error) {
...
func (o *InputMonitorConfigurationMetric) UnmarshalJSON(data []byte) (err error) {
	...
	varInputMonitorConfigurationMetric := _InputMonitorConfigurationMetric{}

	err = json.Unmarshal(data, &varInputMonitorConfigurationMetric)

	if err != nil {
		return err
	}

	*o = InputMonitorConfigurationMetric(varInputMonitorConfigurationMetric)
...
type NullableInputMonitorConfigurationMetric struct {
	value *InputMonitorConfigurationMetric
	isSet bool
}

func (v NullableInputMonitorConfigurationMetric) Get() *InputMonitorConfigurationMetric {
	return v.value
}

func (v *NullableInputMonitorConfigurationMetric) Set(val *InputMonitorConfigurationMetric) {
	v.value = val
	v.isSet = true
}

func (v NullableInputMonitorConfigurationMetric) IsSet() bool {
	return v.isSet
}

func (v *NullableInputMonitorConfigurationMetric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInputMonitorConfigurationMetric(val *InputMonitorConfigurationMetric) *NullableInputMonitorConfigurationMetric {
	return &NullableInputMonitorConfigurationMetric{value: val, isSet: true}
}

func (v NullableInputMonitorConfigurationMetric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInputMonitorConfigurationMetric) UnmarshalJSON(src []byte) error {
	v.isSet = true
