...
// checks if the Route1ProcessorsInnerAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Route1ProcessorsInnerAnyOf1{}

// Route1ProcessorsInnerAnyOf1 struct for Route1ProcessorsInnerAnyOf1
type Route1ProcessorsInnerAnyOf1 struct {
	...
	Params Route1ProcessorsInnerAnyOf1Params `json:"params"`
}

type _Route1ProcessorsInnerAnyOf1 Route1ProcessorsInnerAnyOf1
...
func NewRoute1ProcessorsInnerAnyOf1(id string, name string, type_ string, params Route1ProcessorsInnerAnyOf1Params) *Route1ProcessorsInnerAnyOf1 {
	this := Route1ProcessorsInnerAnyOf1{}
	this.Id = id
	this.Name = name
	this.Type = type_
	this.Params = params
...
func (o *Route1ProcessorsInnerAnyOf1) GetParams() Route1ProcessorsInnerAnyOf1Params {
	if o == nil {
		var ret Route1ProcessorsInnerAnyOf1Params
		return ret
	}
...
func (o Route1ProcessorsInnerAnyOf1) MarshalJSON() ([]byte, error) {
...
func (o Route1ProcessorsInnerAnyOf1) ToMap() (map[string]interface{}, error) {
...
func (o *Route1ProcessorsInnerAnyOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varRoute1ProcessorsInnerAnyOf1 := _Route1ProcessorsInnerAnyOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoute1ProcessorsInnerAnyOf1)

	if err != nil {
		return err
	}

	*o = Route1ProcessorsInnerAnyOf1(varRoute1ProcessorsInnerAnyOf1)

	return err
}

type NullableRoute1ProcessorsInnerAnyOf1 struct {
	value *Route1ProcessorsInnerAnyOf1
	isSet bool
}

func (v NullableRoute1ProcessorsInnerAnyOf1) Get() *Route1ProcessorsInnerAnyOf1 {
	return v.value
}

func (v *NullableRoute1ProcessorsInnerAnyOf1) Set(val *Route1ProcessorsInnerAnyOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableRoute1ProcessorsInnerAnyOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableRoute1ProcessorsInnerAnyOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoute1ProcessorsInnerAnyOf1(val *Route1ProcessorsInnerAnyOf1) *NullableRoute1ProcessorsInnerAnyOf1 {
	return &NullableRoute1ProcessorsInnerAnyOf1{value: val, isSet: true}
}

func (v NullableRoute1ProcessorsInnerAnyOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoute1ProcessorsInnerAnyOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
