...
// checks if the SearchSpansResponseDataSpansInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchSpansResponseDataSpansInner{}

// SearchSpansResponseDataSpansInner struct for SearchSpansResponseDataSpansInner
type SearchSpansResponseDataSpansInner struct {
...
type _SearchSpansResponseDataSpansInner SearchSpansResponseDataSpansInner
...
func NewSearchSpansResponseDataSpansInner(resourceAttributes map[string]interface{}, spanAttributes map[string]interface{}, duration float32, startTime string, endTime string, spanId string, span SearchSpansResponseDataSpansInnerSpan, traceId string) *SearchSpansResponseDataSpansInner {
	this := SearchSpansResponseDataSpansInner{}
...
func (o SearchSpansResponseDataSpansInner) MarshalJSON() ([]byte, error) {
...
func (o SearchSpansResponseDataSpansInner) ToMap() (map[string]interface{}, error) {
...
func (o *SearchSpansResponseDataSpansInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchSpansResponseDataSpansInner := _SearchSpansResponseDataSpansInner{}

	err = json.Unmarshal(data, &varSearchSpansResponseDataSpansInner)

	if err != nil {
		return err
	}

	*o = SearchSpansResponseDataSpansInner(varSearchSpansResponseDataSpansInner)
...
type NullableSearchSpansResponseDataSpansInner struct {
	value *SearchSpansResponseDataSpansInner
	isSet bool
}

func (v NullableSearchSpansResponseDataSpansInner) Get() *SearchSpansResponseDataSpansInner {
	return v.value
}

func (v *NullableSearchSpansResponseDataSpansInner) Set(val *SearchSpansResponseDataSpansInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchSpansResponseDataSpansInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchSpansResponseDataSpansInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchSpansResponseDataSpansInner(val *SearchSpansResponseDataSpansInner) *NullableSearchSpansResponseDataSpansInner {
	return &NullableSearchSpansResponseDataSpansInner{value: val, isSet: true}
}

func (v NullableSearchSpansResponseDataSpansInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchSpansResponseDataSpansInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
