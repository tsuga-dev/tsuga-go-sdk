...
// checks if the InputGraphVisualizationBarConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InputGraphVisualizationBarConnection{}

// InputGraphVisualizationBarConnection struct for InputGraphVisualizationBarConnection
type InputGraphVisualizationBarConnection struct {
...
type _InputGraphVisualizationBarConnection InputGraphVisualizationBarConnection
...
func NewInputGraphVisualizationBarConnection(type_ string, connectionId string, queries []string) *InputGraphVisualizationBarConnection {
	this := InputGraphVisualizationBarConnection{}
	this.Type = type_
...
func (o InputGraphVisualizationBarConnection) MarshalJSON() ([]byte, error) {
...
func (o InputGraphVisualizationBarConnection) ToMap() (map[string]interface{}, error) {
...
func (o *InputGraphVisualizationBarConnection) UnmarshalJSON(data []byte) (err error) {
	...
	varInputGraphVisualizationBarConnection := _InputGraphVisualizationBarConnection{}

	err = json.Unmarshal(data, &varInputGraphVisualizationBarConnection)

	if err != nil {
		return err
	}

	*o = InputGraphVisualizationBarConnection(varInputGraphVisualizationBarConnection)
...
type NullableInputGraphVisualizationBarConnection struct {
	value *InputGraphVisualizationBarConnection
	isSet bool
}

func (v NullableInputGraphVisualizationBarConnection) Get() *InputGraphVisualizationBarConnection {
	return v.value
}

func (v *NullableInputGraphVisualizationBarConnection) Set(val *InputGraphVisualizationBarConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableInputGraphVisualizationBarConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableInputGraphVisualizationBarConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInputGraphVisualizationBarConnection(val *InputGraphVisualizationBarConnection) *NullableInputGraphVisualizationBarConnection {
	return &NullableInputGraphVisualizationBarConnection{value: val, isSet: true}
}

func (v NullableInputGraphVisualizationBarConnection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInputGraphVisualizationBarConnection) UnmarshalJSON(src []byte) error {
	v.isSet = true
