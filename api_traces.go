...
func (r TracesAPISearchSpansRequest) From(from int64) TracesAPISearchSpansRequest {
	r.from = &from
	return r
}

// End timestamp in seconds
func (r TracesAPISearchSpansRequest) To(to int64) TracesAPISearchSpansRequest {
	r.to = &to
	return r
}
