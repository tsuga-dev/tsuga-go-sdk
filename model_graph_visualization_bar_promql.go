...
// checks if the GraphVisualizationBarPromql type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GraphVisualizationBarPromql{}

// GraphVisualizationBarPromql struct for GraphVisualizationBarPromql
type GraphVisualizationBarPromql struct {
...
type _GraphVisualizationBarPromql GraphVisualizationBarPromql
...
func NewGraphVisualizationBarPromql(type_ string, queries []string) *GraphVisualizationBarPromql {
	this := GraphVisualizationBarPromql{}
	this.Type = type_
...
func (o GraphVisualizationBarPromql) MarshalJSON() ([]byte, error) {
...
func (o GraphVisualizationBarPromql) ToMap() (map[string]interface{}, error) {
...
func (o *GraphVisualizationBarPromql) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphVisualizationBarPromql := _GraphVisualizationBarPromql{}

	err = json.Unmarshal(data, &varGraphVisualizationBarPromql)

	if err != nil {
		return err
	}

	*o = GraphVisualizationBarPromql(varGraphVisualizationBarPromql)
...
type NullableGraphVisualizationBarPromql struct {
	value *GraphVisualizationBarPromql
	isSet bool
}

func (v NullableGraphVisualizationBarPromql) Get() *GraphVisualizationBarPromql {
	return v.value
}

func (v *NullableGraphVisualizationBarPromql) Set(val *GraphVisualizationBarPromql) {
	v.value = val
	v.isSet = true
}

func (v NullableGraphVisualizationBarPromql) IsSet() bool {
	return v.isSet
}

func (v *NullableGraphVisualizationBarPromql) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGraphVisualizationBarPromql(val *GraphVisualizationBarPromql) *NullableGraphVisualizationBarPromql {
	return &NullableGraphVisualizationBarPromql{value: val, isSet: true}
}

func (v NullableGraphVisualizationBarPromql) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGraphVisualizationBarPromql) UnmarshalJSON(src []byte) error {
	v.isSet = true
