...
// Team Collection of users used to manage ownership, visibility, and access to team-owned Tsuga resources. See [Teams](/documentation/account-and-settings/teams).
type Team struct {
	// Unique identifier of the team. Generated by Tsuga and stable for the team lifetime.
	Id string `json:"id"`
