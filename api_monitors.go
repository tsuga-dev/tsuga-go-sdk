...
func (r ApiDeleteMonitorRequest) Execute() (*DeleteDashboard200Response, *http.Response, error) {
...
func (a *MonitorsAPIService) DeleteMonitorExecute(r ApiDeleteMonitorRequest) (*DeleteDashboard200Response, *http.Response, error) {
	var (
