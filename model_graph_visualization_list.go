...
type GraphVisualizationList struct {
	...
	// Whether list widget cell text wraps instead of truncating. Set by the dashboard author for list widgets. Optional on create or update and returned when configured.
