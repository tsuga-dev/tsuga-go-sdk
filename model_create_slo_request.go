...
// CreateSloRequest SLO creation request. Provide ownership, data access, SLI configuration, target, timeframe, optional cluster scope, and the alerts to create.
type CreateSloRequest struct {
	...
	// Alerts to create on this SLO. Send an empty array for none.
	Alerts               []CreateSloRequestAlertsInner `json:"alerts"`
...
func (o *CreateSloRequest) SetDescriptionNil() {
...
func (o *CreateSloRequest) GetAlerts() []CreateSloRequestAlertsInner {
	if o == nil {
		var ret []CreateSloRequestAlertsInner
		return ret
	}
...
func (o *CreateSloRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCreateSloRequest)
