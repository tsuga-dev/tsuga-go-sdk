...
// checks if the GraphVisualizationPiePromql type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GraphVisualizationPiePromql{}

// GraphVisualizationPiePromql struct for GraphVisualizationPiePromql
type GraphVisualizationPiePromql struct {
...
type _GraphVisualizationPiePromql GraphVisualizationPiePromql
...
func NewGraphVisualizationPiePromql(type_ string, queries []string) *GraphVisualizationPiePromql {
	this := GraphVisualizationPiePromql{}
	this.Type = type_
...
func (o GraphVisualizationPiePromql) MarshalJSON() ([]byte, error) {
...
func (o GraphVisualizationPiePromql) ToMap() (map[string]interface{}, error) {
...
func (o *GraphVisualizationPiePromql) UnmarshalJSON(data []byte) (err error) {
	...
	varGraphVisualizationPiePromql := _GraphVisualizationPiePromql{}

	err = json.Unmarshal(data, &varGraphVisualizationPiePromql)

	if err != nil {
		return err
	}

	*o = GraphVisualizationPiePromql(varGraphVisualizationPiePromql)
...
type NullableGraphVisualizationPiePromql struct {
	value *GraphVisualizationPiePromql
	isSet bool
}

func (v NullableGraphVisualizationPiePromql) Get() *GraphVisualizationPiePromql {
	return v.value
}

func (v *NullableGraphVisualizationPiePromql) Set(val *GraphVisualizationPiePromql) {
	v.value = val
	v.isSet = true
}

func (v NullableGraphVisualizationPiePromql) IsSet() bool {
	return v.isSet
}

func (v *NullableGraphVisualizationPiePromql) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGraphVisualizationPiePromql(val *GraphVisualizationPiePromql) *NullableGraphVisualizationPiePromql {
	return &NullableGraphVisualizationPiePromql{value: val, isSet: true}
}

func (v NullableGraphVisualizationPiePromql) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGraphVisualizationPiePromql) UnmarshalJSON(src []byte) error {
	v.isSet = true
