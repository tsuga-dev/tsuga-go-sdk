# InputMonitorConfigurationAnomalyTrace

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Type** | **string** | Anomaly monitor over trace aggregations. Set this value to create or update an anomaly monitor that learns historical trace query behavior and alerts on unusual movement in trace-derived values. | 
...
### NewInputMonitorConfigurationAnomalyTrace
...
NewInputMonitorConfigurationAnomalyTrace instantiates a new InputMonitorConfigurationAnomalyTrace object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewInputMonitorConfigurationAnomalyTraceWithDefaults

`func NewInputMonitorConfigurationAnomalyTraceWithDefaults() *InputMonitorConfigurationAnomalyTrace`

NewInputMonitorConfigurationAnomalyTraceWithDefaults instantiates a new InputMonitorConfigurationAnomalyTrace object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetType

`func (o *InputMonitorConfigurationAnomalyTrace) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *InputMonitorConfigurationAnomalyTrace) GetTypeOk() (*string, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetType(v string)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetCondition() InputMonitorConfigurationAnomalyLogCondition`

GetCondition returns the Condition field if non-nil, zero value otherwise.

### GetConditionOk

`func (o *InputMonitorConfigurationAnomalyTrace) GetConditionOk() (*InputMonitorConfigurationAnomalyLogCondition, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetCondition(v InputMonitorConfigurationAnomalyLogCondition)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetNoDataBehavior() string`

GetNoDataBehavior returns the NoDataBehavior field if non-nil, zero value otherwise.

### GetNoDataBehaviorOk

`func (o *InputMonitorConfigurationAnomalyTrace) GetNoDataBehaviorOk() (*string, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetNoDataBehavior(v string)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetGroupByFields() []InputMonitorConfigurationMetricGroupByFieldsInner`

GetGroupByFields returns the GroupByFields field if non-nil, zero value otherwise.

### GetGroupByFieldsOk

`func (o *InputMonitorConfigurationAnomalyTrace) GetGroupByFieldsOk() (*[]InputMonitorConfigurationMetricGroupByFieldsInner, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetGroupByFields(v []InputMonitorConfigurationMetricGroupByFieldsInner)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetAggregationAlertLogic() string`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetAggregationAlertLogicOk() (*string, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetAggregationAlertLogic(v string)`

SetAggregationAlertLogic sets AggregationAlertLogic field to given value.

### HasAggregationAlertLogic

`func (o *InputMonitorConfigurationAnomalyTrace) HasAggregationAlertLogic() bool`

HasAggregationAlertLogic returns a boolean if a field has been set.

### GetProportionAlertThreshold

`func (o *InputMonitorConfigurationAnomalyTrace) GetProportionAlertThreshold() int32`
...
`func (o *InputMonitorConfigurationAnomalyTrace) GetProportionAlertThresholdOk() (*int32, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetProportionAlertThreshold(v int32)`

SetProportionAlertThreshold sets ProportionAlertThreshold field to given value.

### HasProportionAlertThreshold

`func (o *InputMonitorConfigurationAnomalyTrace) HasProportionAlertThreshold() bool`

HasProportionAlertThreshold returns a boolean if a field has been set.

### GetQueries

`func (o *InputMonitorConfigurationAnomalyTrace) GetQueries() []MonitorAggregationQuery1`

GetQueries returns the Queries field if non-nil, zero value otherwise.

### GetQueriesOk

`func (o *InputMonitorConfigurationAnomalyTrace) GetQueriesOk() (*[]MonitorAggregationQuery1, bool)`
...
`func (o *InputMonitorConfigurationAnomalyTrace) SetQueries(v []MonitorAggregationQuery1)`
