...
`func (o *RuleTargetInputEmail) GetRenotifyConfig() RuleTargetInputSlackRenotifyConfig`

GetRenotifyConfig returns the RenotifyConfig field if non-nil, zero value otherwise.

### GetRenotifyConfigOk

`func (o *RuleTargetInputEmail) GetRenotifyConfigOk() (*RuleTargetInputSlackRenotifyConfig, bool)`
...
`func (o *RuleTargetInputEmail) SetRenotifyConfig(v RuleTargetInputSlackRenotifyConfig)`

SetRenotifyConfig sets RenotifyConfig field to given value.

### HasRenotifyConfig

`func (o *RuleTargetInputEmail) HasRenotifyConfig() bool`
