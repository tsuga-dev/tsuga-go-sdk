...
`func (o *RuleTargetConfigGoogleChat) GetRenotifyConfig() RuleTargetConfigSlackRenotifyConfig`

GetRenotifyConfig returns the RenotifyConfig field if non-nil, zero value otherwise.

### GetRenotifyConfigOk

`func (o *RuleTargetConfigGoogleChat) GetRenotifyConfigOk() (*RuleTargetConfigSlackRenotifyConfig, bool)`
...
`func (o *RuleTargetConfigGoogleChat) SetRenotifyConfig(v RuleTargetConfigSlackRenotifyConfig)`

SetRenotifyConfig sets RenotifyConfig field to given value.

### HasRenotifyConfig

`func (o *RuleTargetConfigGoogleChat) HasRenotifyConfig() bool`
